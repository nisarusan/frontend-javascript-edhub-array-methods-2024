...
console.log(
    inventors.filter(user => user.year > 1560 && user.year < 1620)
)
...
console.log(
    inventors.map(user => user.first + " " +  user.last)
)
...
console.log(
    inventors.find(user => user.last === "Edison")
);
